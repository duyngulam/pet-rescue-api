...
**ALL controllers MUST follow this pattern (see PetController, AuthController, OrganizationController):**
...
- For read-only queries, use `@Transactional(readOnly = true)` on domain service query methods
